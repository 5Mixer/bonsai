...
var Goblin = function(x,y) {
	...
	this.position.x = x;
	this.position.y = y;
	this.spriteMap = new bonsai_render_SpriteMap(kha_Assets.images.goblinRun,16,16);
};
...
bonsai_Engine.prototype = {
	events: null
	,currentScene: null
	,start: function(title,width,height) {
		if(height == null) {
			height = 600;
		}
		if(width == null) {
