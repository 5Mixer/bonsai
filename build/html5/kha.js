...
var GameEvents = $hxEnums["GameEvents"] = { __ename__ : true, __constructs__ : ["PlayerEat"]
	,PlayerEat: ($_=function(food) { return {_hx_index:0,food:food,__enum__:"GameEvents",toString:$estr}; },$_.__params__ = ["food"],$_)
};
var Main = function() { };
$hxClasses["Main"] = Main;
Main.__name__ = true;
...
Main.onAssetLoad = function() {
	var scene1 = new bonsai_scene_Scene("Scene");
	Main.engine.currentScene = new Level2();
};
var bonsai_entity_Entity = function() {
	this.visible = true;
	this.active = true;
	this.position = new kha_math_Vector2();
};
$hxClasses["bonsai.entity.Entity"] = bonsai_entity_Entity;
...
Player.__super__ = bonsai_entity_Entity;
Player.prototype = $extend(bonsai_entity_Entity.prototype,{
	width: null
	,height: null
...
var Goblin = function(x,y) {
	...
	this.position.x = x;
	this.position.y = y;
	this.animation = new bonsai_render_AnimatedSprite(new bonsai_render_SpriteMap(kha_Assets.images.goblinRun,this.width,this.height));
	...
	this.transformation.origin = new kha_math_Vector2(this.width / 2,this.height / 2);
	this.transformation.scale = new kha_math_Vector2(8,8);
};
$hxClasses["Goblin"] = Goblin;
Goblin.__name__ = true;
Goblin.__super__ = bonsai_entity_Entity;
Goblin.prototype = $extend(bonsai_entity_Entity.prototype,{
	width: null
	,height: null
	,spriteMap: null
	,animation: null
...
var bonsai_scene_Scene = function(name) {
	this.layers = [];
	this.name = name;
};
$hxClasses["bonsai.scene.Scene"] = bonsai_scene_Scene;
...
var Level1 = function() {
	bonsai_scene_Scene.call(this,"Level1");
	this.add(new Player(300,100,30,60));
};
$hxClasses["Level1"] = Level1;
Level1.__name__ = true;
Level1.__super__ = bonsai_scene_Scene;
Level1.prototype = $extend(bonsai_scene_Scene.prototype,{
	__class__: Level1
});
var Level2 = function() {
	bonsai_scene_Scene.call(this,"Level2");
	this.add(new Goblin(20,50));
};
$hxClasses["Level2"] = Level2;
Level2.__name__ = true;
Level2.__super__ = bonsai_scene_Scene;
Level2.prototype = $extend(bonsai_scene_Scene.prototype,{
	__class__: Level2
});
var StartMenu = function() {
	bonsai_scene_Scene.call(this,"Start Menu");
};
$hxClasses["StartMenu"] = StartMenu;
StartMenu.__name__ = true;
StartMenu.__super__ = bonsai_scene_Scene;
StartMenu.prototype = $extend(bonsai_scene_Scene.prototype,{
	__class__: StartMenu
});
Math.__name__ = true;
...
var bonsai_Engine = function() {
};
$hxClasses["bonsai.Engine"] = bonsai_Engine;
...
var bonsai_event_BonsaiEvent = $hxEnums["bonsai.event.BonsaiEvent"] = { __ename__ : true, __constructs__ : []
};
var bonsai_event_EventSystem = function() {
};
$hxClasses["bonsai.event.EventSystem"] = bonsai_event_EventSystem;
...
var bonsai_render_AnimatedSprite = function(spriteMap) {
	this.frameTime = .1;
	this.lastFrameTime = 0;
	this.spriteMap = spriteMap;
	this.animations = new haxe_ds_StringMap();
};
$hxClasses["bonsai.render.AnimatedSprite"] = bonsai_render_AnimatedSprite;
...
bonsai_render_AnimatedSprite.prototype = {
	...
	,update: function(dt) {
		if(kha_Scheduler.time() > this.lastFrameTime + this.frameTime) {
			this.lastFrameTime = kha_Scheduler.time();
...
var bonsai_render_SpriteMap = function(image,gridWidth,gridHeight) {
	this.image = image;
...
$hxClasses["bonsai.render.SpriteMap"] = bonsai_render_SpriteMap;
...
var bonsai_render_Transformation = function() {
	...
	this.scale = new kha_math_Vector2();
...
bonsai_render_Transformation.prototype = {
	...
	,apply: function(graphics) {
		...
		var _this__001 = Math.cos(alpha);
		var _this__101 = -Math.sin(alpha);
		var _this__201 = 0;
		var _this__011 = Math.sin(alpha);
		var _this__111 = Math.cos(alpha);
		var _this__211 = 0;
		var _this__021 = 0;
		var _this__121 = 0;
		var _this__221 = 1;
		...
		var _this__002 = _this__00 * m__002 + _this__10 * m__012 + _this__20 * m__022;
		var _this__102 = _this__00 * m__102 + _this__10 * m__112 + _this__20 * m__122;
		var _this__202 = _this__00 * m__202 + _this__10 * m__212 + _this__20 * m__222;
		var _this__012 = _this__01 * m__002 + _this__11 * m__012 + _this__21 * m__022;
		var _this__112 = _this__01 * m__102 + _this__11 * m__112 + _this__21 * m__122;
		var _this__212 = _this__01 * m__202 + _this__11 * m__212 + _this__21 * m__222;
		var _this__022 = _this__02 * m__002 + _this__12 * m__012 + _this__22 * m__022;
		var _this__122 = _this__02 * m__102 + _this__12 * m__112 + _this__22 * m__122;
		var _this__222 = _this__02 * m__202 + _this__12 * m__212 + _this__22 * m__222;
		var m__003 = 1;
		var m__103 = 0;
		var m__203 = -this.offset.x - this.origin.x;
		var m__013 = 0;
		var m__113 = 1;
		var m__213 = -this.offset.y - this.origin.y;
		var m__023 = 0;
		var m__123 = 0;
		var m__223 = 1;
...
var kha__$Assets_ImageList = function() {
	this.names = ["goblinRun"];
	this.goblinRunDescription = { name : "goblinRun", original_height : 16, file_sizes : [422], original_width : 96, files : ["goblinRun.png"], type : "image"};
	this.goblinRunName = "goblinRun";
	this.goblinRun = null;
};
...
kha__$Assets_ImageList.prototype = {
	...
	,goblinRun: null
	,goblinRunName: null
	,goblinRunDescription: null
	,goblinRunLoad: function(done,failure) {
		kha_Assets.loadImage("goblinRun",function(image) {
			done();
		},failure,{ fileName : "kha/internal/AssetsBuilder.hx", lineNumber : 126, className : "kha._Assets.ImageList", methodName : "goblinRunLoad"});
	}
	,goblinRunUnload: function() {
		this.goblinRun.unload();
		this.goblinRun = null;
	}
	,names: null
...
var kha__$Assets_BlobList = function() {
	this.names = ["goblinRun_pyxel"];
	this.goblinRun_pyxelDescription = { name : "goblinRun_pyxel", file_sizes : [1080], files : ["goblinRun.pyxel"], type : "blob"};
	this.goblinRun_pyxelName = "goblinRun_pyxel";
	this.goblinRun_pyxel = null;
};
...
kha__$Assets_BlobList.prototype = {
	...
	,goblinRun_pyxel: null
	,goblinRun_pyxelName: null
	,goblinRun_pyxelDescription: null
	,goblinRun_pyxelLoad: function(done,failure) {
		kha_Assets.loadBlob("goblinRun_pyxel",function(blob) {
			done();
		},failure,{ fileName : "kha/internal/AssetsBuilder.hx", lineNumber : 134, className : "kha._Assets.BlobList", methodName : "goblinRun_pyxelLoad"});
	}
	,goblinRun_pyxelUnload: function() {
		this.goblinRun_pyxel.unload();
		this.goblinRun_pyxel = null;
	}
	,names: null
