...
var Goblin = function(x,y) {
	...
	this.position.x = x;
	this.position.y = y;
	this.animation = new bonsai_render_AnimatedSprite(new bonsai_render_SpriteMap(kha_Assets.images.goblinRunSheet,this.width,this.height));
...
var kha__$Assets_BlobList = function() {
	this.names = ["goblinRun_aseprite"];
	this.goblinRun_asepriteDescription = { name : "goblinRun_aseprite", file_sizes : [1220], files : ["goblinRun.aseprite"], type : "blob"};
	this.goblinRun_asepriteName = "goblinRun_aseprite";
	this.goblinRun_aseprite = null;
};
...
kha__$Assets_BlobList.prototype = {
	...
	,goblinRun_aseprite: null
	,goblinRun_asepriteName: null
	,goblinRun_asepriteDescription: null
	,goblinRun_asepriteLoad: function(done,failure) {
		kha_Assets.loadBlob("goblinRun_aseprite",function(blob) {
			done();
		},failure,{ fileName : "kha/internal/AssetsBuilder.hx", lineNumber : 134, className : "kha._Assets.BlobList", methodName : "goblinRun_asepriteLoad"});
	}
	,goblinRun_asepriteUnload: function() {
		this.goblinRun_aseprite.unload();
		this.goblinRun_aseprite = null;
	}
	,names: null
