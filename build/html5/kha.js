...
Player.prototype = $extend(bonsai_entity_Entity.prototype,{
	...
	,render: function(canvas) {
		...
		haxe_Log.trace("Rendered Player",{ fileName : "Main.hx", lineNumber : 32, className : "Player", methodName : "render"});
		bonsai_entity_Entity.prototype.render.call(this,canvas);
	}
	,__class__: Player
});
