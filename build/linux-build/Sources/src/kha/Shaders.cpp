...
HXDLIN( 149)							{
HXLINE( 174)								{
HXLINE( 175)									::Array< ::Dynamic> blobs = ::Array_obj< ::Dynamic>::__new();
HXLINE( 176)									{
HXLINE( 177)										::String data = ( (::String)(::Reflect_obj::field(hx::ClassOf< ::kha::Shaders >(),(HX_("painter_colored_fragData",8d,d9,25,8d) + 0))) );
HXLINE( 178)										 ::haxe::io::Bytes bytes = ( ( ::haxe::io::Bytes)(::haxe::Unserializer_obj::run(data)) );
HXLINE( 179)										blobs->push(::kha::internal::BytesBlob_obj::fromBytes(bytes));
            									}
HXLINE( 181)									::kha::Shaders_obj::painter_colored_frag =  ::kha::graphics4::FragmentShader_obj::__alloc( HX_CTX ,blobs,::Array_obj< ::String >::fromData( _hx_array_data_5c987b44_1,1));
            								}
HXLINE( 151)								{
HXLINE( 152)									::Array< ::Dynamic> blobs1 = ::Array_obj< ::Dynamic>::__new();
HXLINE( 153)									{
HXLINE( 154)										::String data1 = ( (::String)(::Reflect_obj::field(hx::ClassOf< ::kha::Shaders >(),(HX_("painter_colored_vertData",8c,a0,fc,4b) + 0))) );
HXLINE( 155)										 ::haxe::io::Bytes bytes1 = ( ( ::haxe::io::Bytes)(::haxe::Unserializer_obj::run(data1)) );
HXLINE( 156)										blobs1->push(::kha::internal::BytesBlob_obj::fromBytes(bytes1));
            									}
HXLINE( 158)									::kha::Shaders_obj::painter_colored_vert =  ::kha::graphics4::VertexShader_obj::__alloc( HX_CTX ,blobs1,::Array_obj< ::String >::fromData( _hx_array_data_5c987b44_2,1));
            								}
            							}
HXLINE( 174)							{
HXLINE( 175)								::Array< ::Dynamic> blobs2 = ::Array_obj< ::Dynamic>::__new();
HXLINE( 176)								{
HXLINE( 177)									::String data2 = ( (::String)(::Reflect_obj::field(hx::ClassOf< ::kha::Shaders >(),(HX_("painter_image_fragData",94,7a,37,e2) + 0))) );
HXLINE( 178)									 ::haxe::io::Bytes bytes2 = ( ( ::haxe::io::Bytes)(::haxe::Unserializer_obj::run(data2)) );
HXLINE( 179)									blobs2->push(::kha::internal::BytesBlob_obj::fromBytes(bytes2));
            								}
HXLINE( 181)								::kha::Shaders_obj::painter_image_frag =  ::kha::graphics4::FragmentShader_obj::__alloc( HX_CTX ,blobs2,::Array_obj< ::String >::fromData( _hx_array_data_5c987b44_3,1));
            							}
            						}
HXLINE( 151)						{
HXLINE( 152)							::Array< ::Dynamic> blobs3 = ::Array_obj< ::Dynamic>::__new();
HXLINE( 153)							{
HXLINE( 154)								::String data3 = ( (::String)(::Reflect_obj::field(hx::ClassOf< ::kha::Shaders >(),(HX_("painter_image_vertData",93,41,0e,a1) + 0))) );
HXLINE( 155)								 ::haxe::io::Bytes bytes3 = ( ( ::haxe::io::Bytes)(::haxe::Unserializer_obj::run(data3)) );
HXLINE( 156)								blobs3->push(::kha::internal::BytesBlob_obj::fromBytes(bytes3));
            							}
HXLINE( 158)							::kha::Shaders_obj::painter_image_vert =  ::kha::graphics4::VertexShader_obj::__alloc( HX_CTX ,blobs3,::Array_obj< ::String >::fromData( _hx_array_data_5c987b44_4,1));
            						}
            					}
HXLINE( 174)					{
HXLINE( 175)						::Array< ::Dynamic> blobs4 = ::Array_obj< ::Dynamic>::__new();
HXLINE( 176)						{
HXLINE( 177)							::String data4 = ( (::String)(::Reflect_obj::field(hx::ClassOf< ::kha::Shaders >(),(HX_("painter_text_fragData",9a,ea,65,f3) + 0))) );
HXLINE( 178)							 ::haxe::io::Bytes bytes4 = ( ( ::haxe::io::Bytes)(::haxe::Unserializer_obj::run(data4)) );
HXLINE( 179)							blobs4->push(::kha::internal::BytesBlob_obj::fromBytes(bytes4));
            						}
HXLINE( 181)						::kha::Shaders_obj::painter_text_frag =  ::kha::graphics4::FragmentShader_obj::__alloc( HX_CTX ,blobs4,::Array_obj< ::String >::fromData( _hx_array_data_5c987b44_5,1));
            					}
            				}
HXLINE( 151)				{
HXLINE( 152)					::Array< ::Dynamic> blobs5 = ::Array_obj< ::Dynamic>::__new();
HXLINE( 153)					{
HXLINE( 154)						::String data5 = ( (::String)(::Reflect_obj::field(hx::ClassOf< ::kha::Shaders >(),(HX_("painter_text_vertData",99,b1,3c,b2) + 0))) );
HXLINE( 155)						 ::haxe::io::Bytes bytes5 = ( ( ::haxe::io::Bytes)(::haxe::Unserializer_obj::run(data5)) );
HXLINE( 156)						blobs5->push(::kha::internal::BytesBlob_obj::fromBytes(bytes5));
            					}
HXLINE( 158)					::kha::Shaders_obj::painter_text_vert =  ::kha::graphics4::VertexShader_obj::__alloc( HX_CTX ,blobs5,::Array_obj< ::String >::fromData( _hx_array_data_5c987b44_6,1));
            				}
            			}
HXLINE( 174)			{
HXLINE( 175)				::Array< ::Dynamic> blobs6 = ::Array_obj< ::Dynamic>::__new();
HXLINE( 176)				{
HXLINE( 177)					::String data6 = ( (::String)(::Reflect_obj::field(hx::ClassOf< ::kha::Shaders >(),(HX_("painter_video_fragData",74,e1,6c,f4) + 0))) );
HXLINE( 178)					 ::haxe::io::Bytes bytes6 = ( ( ::haxe::io::Bytes)(::haxe::Unserializer_obj::run(data6)) );
HXLINE( 179)					blobs6->push(::kha::internal::BytesBlob_obj::fromBytes(bytes6));
            				}
HXLINE( 181)				::kha::Shaders_obj::painter_video_frag =  ::kha::graphics4::FragmentShader_obj::__alloc( HX_CTX ,blobs6,::Array_obj< ::String >::fromData( _hx_array_data_5c987b44_7,1));
            			}
            		}
HXLINE( 151)		{
HXLINE( 152)			::Array< ::Dynamic> blobs7 = ::Array_obj< ::Dynamic>::__new();
HXLINE( 153)			{
HXLINE( 154)				::String data7 = ( (::String)(::Reflect_obj::field(hx::ClassOf< ::kha::Shaders >(),(HX_("painter_video_vertData",73,a8,43,b3) + 0))) );
HXLINE( 155)				 ::haxe::io::Bytes bytes7 = ( ( ::haxe::io::Bytes)(::haxe::Unserializer_obj::run(data7)) );
HXLINE( 156)				blobs7->push(::kha::internal::BytesBlob_obj::fromBytes(bytes7));
            			}
HXLINE( 158)			::kha::Shaders_obj::painter_video_vert =  ::kha::graphics4::VertexShader_obj::__alloc( HX_CTX ,blobs7,::Array_obj< ::String >::fromData( _hx_array_data_5c987b44_8,1));
            		}
            	}
...
HXDLIN(  42)		painter_colored_fragData0 = HX_("s260:",36,9f,18,fa);
            	}
{
...
{
            	HX_STACKFRAME(&_hx_pos_6dc83ef3f0d80db1_42_boot)
HXDLIN(  42)		painter_colored_vertData0 = HX_("s463:",0b,e6,fa,98);
            	}
{
...
{
            	HX_STACKFRAME(&_hx_pos_6dc83ef3f0d80db1_42_boot)
HXDLIN(  42)		painter_image_fragData0 = HX_("s502:",30,a3,6f,69);
            	}
{
            	HX_STACKFRAME(&_hx_pos_6dc83ef3f0d80db1_168_boot)
...
{
            	HX_STACKFRAME(&_hx_pos_6dc83ef3f0d80db1_42_boot)
HXDLIN(  42)		painter_image_vertData0 = HX_("s547:",c7,d5,c1,9b);
            	}
{
            	HX_STACKFRAME(&_hx_pos_6dc83ef3f0d80db1_145_boot)
...
{
            	HX_STACKFRAME(&_hx_pos_6dc83ef3f0d80db1_42_boot)
HXDLIN(  42)		painter_text_fragData0 = HX_("s398:",be,41,e5,00);
            	}
{
            	HX_STACKFRAME(&_hx_pos_6dc83ef3f0d80db1_168_boot)
...
{
            	HX_STACKFRAME(&_hx_pos_6dc83ef3f0d80db1_42_boot)
HXDLIN(  42)		painter_text_vertData0 = HX_("s568:",54,7f,4b,20);
            	}
{
            	HX_STACKFRAME(&_hx_pos_6dc83ef3f0d80db1_145_boot)
...
{
            	HX_STACKFRAME(&_hx_pos_6dc83ef3f0d80db1_42_boot)
HXDLIN(  42)		painter_video_fragData0 = HX_("s502:",30,a3,6f,69);
            	}
{
            	HX_STACKFRAME(&_hx_pos_6dc83ef3f0d80db1_168_boot)
...
{
            	HX_STACKFRAME(&_hx_pos_6dc83ef3f0d80db1_42_boot)
HXDLIN(  42)		painter_video_vertData0 = HX_("s547:",c7,d5,c1,9b);
            	}
{
            	HX_STACKFRAME(&_hx_pos_6dc83ef3f0d80db1_145_boot)
