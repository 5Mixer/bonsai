...
HXLINE( 530)			{
HXLINE( 530)				 ::kha::audio2::ogg::vorbis::_VorbisDecodeState::FindPageResult _g3 = this->findPage(seekFunc,inputLength);
HXDLIN( 530)				switch((int)(_g3->_hx_getIndex())){
            					case (int)0: {
HXLINE( 531)						bool l1 = _g3->_hx_getBool(1);
HXDLIN( 531)						int e1 = _g3->_hx_getInt(0);
HXDLIN( 531)						{
HXLINE( 532)							end = e1;
HXLINE( 533)							last = l1;
            						}
