...
HXDLIN(  47)			g1->_hx_set_partitionClassList(HX_CTX, this2);
HXLINE(  48)			{
HXLINE(  48)				int _g2 = 0;
...
HXDLIN(  54)			g1->_hx_set_classDimensions(HX_CTX, this4);
HXLINE(  55)			::Array< int > this5 = ::Array_obj< int >::__new((maxClass + 1));
HXDLIN(  55)			g1->_hx_set_classMasterbooks(HX_CTX, this5);
HXLINE(  56)			::Array< int > this6 = ::Array_obj< int >::__new((maxClass + 1));
HXDLIN(  56)			g1->_hx_set_classSubclasses(HX_CTX, this6);
HXLINE(  57)			::Array< ::Dynamic> this7 = ::Array_obj< ::Dynamic>::__new((maxClass + 1));
HXDLIN(  57)			g1->_hx_set_subclassBooks(HX_CTX, this7);
HXLINE(  58)			{
...
HXDLIN(  80)			g1->_hx_set_xlist(HX_CTX, this14);
...
HXDLIN( 101)			g1->_hx_set_sortedOrder(HX_CTX, this16);
HXLINE( 102)			{
...
HXDLIN( 106)			g1->_hx_set_neighbors(HX_CTX, this17);
HXLINE( 108)			{
