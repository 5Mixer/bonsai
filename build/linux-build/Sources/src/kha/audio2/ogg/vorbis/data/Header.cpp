...
HXDLIN( 171)		header1->_hx_set_floorConfig(HX_CTX, this3);
HXLINE( 172)		{
...
HXDLIN( 178)		header1->_hx_set_residueConfig(HX_CTX, this5);
HXLINE( 179)		{
...
HXDLIN( 185)		header1->_hx_set_mapping(HX_CTX, this7);
HXLINE( 186)		{
...
HXDLIN( 200)		header1->_hx_set_modes(HX_CTX, this8);
HXLINE( 201)		{
