...
HXLINE(  75)		{
HXLINE(  75)			int _g2 = 0;
HXDLIN(  75)			int _g11 = samples;
HXDLIN(  75)			while((_g2 < _g11)){
HXLINE(  75)				_g2 = (_g2 + 1);
HXDLIN(  75)				int i1 = (_g2 - 1);
HXLINE(  76)				::kha::audio2::Audio1_obj::sampleCache2->self.set(i1,( (float)(0) ));
            			}
            		}
HXLINE(  80)		::kha::audio2::Audio1_obj::mutex->acquire();
HXLINE(  82)		{
HXLINE(  82)			int _g21 = 0;
HXDLIN(  82)			while((_g21 < 32)){
HXLINE(  82)				_g21 = (_g21 + 1);
HXDLIN(  82)				int i2 = (_g21 - 1);
HXLINE(  83)				{
...
HXLINE(  95)				{
HXLINE(  95)					int _g51 = 0;
HXDLIN(  95)					int _g6 = samples;
HXDLIN(  95)					while((_g51 < _g6)){
HXLINE(  95)						_g51 = (_g51 + 1);
HXDLIN(  95)						int i4 = (_g51 - 1);
HXLINE(  96)						{
HXLINE(  96)							int _g52 = i4;
HXDLIN(  96)							 ::kha::arrays::Float32ArrayPrivate _g61 = ::kha::audio2::Audio1_obj::sampleCache2;
HXDLIN(  96)							{
HXLINE(  96)								float value = _g61->self.get(_g52);
HXDLIN(  96)								float value1 = ::kha::audio2::Audio1_obj::sampleCache1->self.get(i4);
HXDLIN(  96)								float value2 = ( (float)((value + (( (Float)(value1) ) * channel->get_volume()))) );
HXDLIN(  96)								_g61->self.set(_g52,value2);
            							}
            						}
            					}
            				}
...
HXLINE(  99)		{
HXLINE(  99)			int _g62 = 0;
HXDLIN(  99)			::Array< ::Dynamic> _g7 = ::kha::audio2::Audio1_obj::internalStreamChannels;
HXDLIN(  99)			while((_g62 < _g7->length)){
HXLINE(  99)				 ::kha::audio2::StreamChannel channel1 = ( ( ::kha::audio2::StreamChannel)(_hx_array_unsafe_get(_g7,_g62)) );
HXDLIN(  99)				_g62 = (_g62 + 1);
HXLINE( 100)				bool _hx_tmp2;
HXDLIN( 100)				if (hx::IsNotNull( channel1 )) {
HXLINE( 100)					_hx_tmp2 = channel1->get_finished();
            				}
            				else {
...
HXLINE( 101)				channel1->nextSamples(::kha::audio2::Audio1_obj::sampleCache1,samples,buffer->samplesPerSecond);
HXLINE( 102)				{
HXLINE( 102)					int _g71 = 0;
HXDLIN( 102)					int _g8 = samples;
HXDLIN( 102)					while((_g71 < _g8)){
HXLINE( 102)						_g71 = (_g71 + 1);
HXDLIN( 102)						int i5 = (_g71 - 1);
HXLINE( 103)						{
HXLINE( 103)							int _g72 = i5;
HXDLIN( 103)							 ::kha::arrays::Float32ArrayPrivate _g81 = ::kha::audio2::Audio1_obj::sampleCache2;
HXDLIN( 103)							{
HXLINE( 103)								float value3 = _g81->self.get(_g72);
HXDLIN( 103)								float value4 = ::kha::audio2::Audio1_obj::sampleCache1->self.get(i5);
HXDLIN( 103)								float value5 = ( (float)((value3 + (( (Float)(value4) ) * channel1->get_volume()))) );
HXDLIN( 103)								_g81->self.set(_g72,value5);
            							}
            						}
            					}
            				}
...
HXLINE( 107)		{
HXLINE( 107)			int _g82 = 0;
HXDLIN( 107)			int _g9 = samples;
HXDLIN( 107)			while((_g82 < _g9)){
HXLINE( 107)				_g82 = (_g82 + 1);
HXDLIN( 107)				int i6 = (_g82 - 1);
HXLINE( 108)				{
HXLINE( 108)					 ::kha::arrays::Float32ArrayPrivate this5 = buffer->data;
HXDLIN( 108)					int index = buffer->writeLocation;
HXDLIN( 108)					Float a = ( (Float)(::kha::audio2::Audio1_obj::sampleCache2->self.get(i6)) );
HXDLIN( 108)					Float a1;
...
HXDLIN( 108)					float value6;
HXDLIN( 108)					if ((a1 > ((Float)-1.0))) {
HXLINE( 108)						value6 = ( (float)(a1) );
            					}
            					else {
HXLINE( 108)						value6 = ( (float)(((Float)-1.0)) );
            					}
HXDLIN( 108)					this5->self.set(index,value6);
            				}
HXLINE( 109)				 ::kha::audio2::Buffer buffer2 = buffer;
HXDLIN( 109)				buffer2->writeLocation = (buffer2->writeLocation + 1);
...
HXDLIN( 157)				int i1 = (_g1 - 1);
HXLINE( 158)				bool _hx_tmp;
HXDLIN( 158)				bool _hx_tmp1;
HXDLIN( 158)				if (hx::IsNotNull( _hx_array_unsafe_get(::kha::audio2::Audio1_obj::soundChannels,i1) )) {
HXLINE( 158)					_hx_tmp1 = ( ( ::kha::audio2::AudioChannel)(_hx_array_unsafe_get(::kha::audio2::Audio1_obj::soundChannels,i1)) )->get_finished();
            				}
            				else {
HXLINE( 158)					_hx_tmp1 = true;
            				}
HXDLIN( 158)				if (!(_hx_tmp1)) {
HXLINE( 158)					_hx_tmp = hx::IsEq( _hx_array_unsafe_get(::kha::audio2::Audio1_obj::soundChannels,i1),channel );
            				}
            				else {
HXLINE( 158)					_hx_tmp = true;
            				}
HXDLIN( 158)				if (_hx_tmp) {
HXLINE( 159)					::kha::audio2::Audio1_obj::soundChannels->__unsafe_set(i1,channel);
