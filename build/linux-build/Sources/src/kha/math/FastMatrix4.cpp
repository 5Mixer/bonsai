...
HXLINE( 146)			Float mul1 = (( (Float)(1) ) / ( (Float)(currentLength1) ));
HXDLIN( 146)			xaxis_x = (xaxis_x * ( (float)(mul1) ));
HXDLIN( 146)			xaxis_y = (xaxis_y * ( (float)(mul1) ));
HXDLIN( 146)			xaxis_z = (xaxis_z * ( (float)(mul1) ));
            		}
