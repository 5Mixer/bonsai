...
HXLINE(  46)			 ::kha::arrays::Float32ArrayPrivate this2 =  ::kha::arrays::Float32ArrayPrivate_obj::__alloc( HX_CTX ,(samples * 2));
HXDLIN(  46)			this->_hx_set_uncompressedData(HX_CTX, this2);
HXLINE(  47)			{
HXLINE(  47)				int _g2 = 0;
HXDLIN(  47)				int _g11 = (samples * 2);
HXDLIN(  47)				while((_g2 < _g11)){
HXLINE(  47)					_g2 = (_g2 + 1);
HXDLIN(  47)					int i1 = (_g2 - 1);
HXLINE(  48)					this->uncompressedData->self.set(i1, data[i1] / 32767.0f);
            				}
            			}
            		}
