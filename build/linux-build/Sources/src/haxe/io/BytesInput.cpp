...
HX_DEFINE_STACK_FRAME(_hx_pos_8801ea2a6a76db9e_39_new,"haxe.io.BytesInput","new",0x7fa18571,"haxe.io.BytesInput.new","/home/mixer/projects/bonsai/Kha/Tools/haxe/std/haxe/io/BytesInput.hx",39,0xcf520d30)
HX_LOCAL_STACK_FRAME(_hx_pos_8801ea2a6a76db9e_83_set_position,"haxe.io.BytesInput","set_position",0xafd318f5,"haxe.io.BytesInput.set_position","/home/mixer/projects/bonsai/Kha/Tools/haxe/std/haxe/io/BytesInput.hx",83,0xcf520d30)
HX_LOCAL_STACK_FRAME(_hx_pos_8801ea2a6a76db9e_96_readByte,"haxe.io.BytesInput","readByte",0xb70e46cd,"haxe.io.BytesInput.readByte","/home/mixer/projects/bonsai/Kha/Tools/haxe/std/haxe/io/BytesInput.hx",96,0xcf520d30)
HX_LOCAL_STACK_FRAME(_hx_pos_8801ea2a6a76db9e_119_readBytes,"haxe.io.BytesInput","readBytes",0x756fad06,"haxe.io.BytesInput.readBytes","/home/mixer/projects/bonsai/Kha/Tools/haxe/std/haxe/io/BytesInput.hx",119,0xcf520d30)
namespace haxe{
namespace io{

void BytesInput_obj::__construct( ::haxe::io::Bytes b, ::Dynamic pos, ::Dynamic len){
            	HX_GC_STACKFRAME(&_hx_pos_8801ea2a6a76db9e_39_new)
...
int BytesInput_obj::set_position(int p){
            	HX_STACKFRAME(&_hx_pos_8801ea2a6a76db9e_83_set_position)
HXLINE(  84)		if ((p < 0)) {
HXLINE(  85)			p = 0;
            		}
            		else {
...
int BytesInput_obj::readByte(){
            	HX_GC_STACKFRAME(&_hx_pos_8801ea2a6a76db9e_96_readByte)
...
int BytesInput_obj::readBytes( ::haxe::io::Bytes buf,int pos,int len){
            	HX_GC_STACKFRAME(&_hx_pos_8801ea2a6a76db9e_119_readBytes)
