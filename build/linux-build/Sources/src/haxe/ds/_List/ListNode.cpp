...
HX_DEFINE_STACK_FRAME(_hx_pos_d8067612f9234746_266_new,"haxe.ds._List.ListNode","new",0x5847787a,"haxe.ds._List.ListNode.new","/home/mixer/projects/bonsai/Kha/Tools/haxe/std/haxe/ds/List.hx",266,0x263cbbba)
namespace haxe{
namespace ds{
namespace _List{

void ListNode_obj::__construct( ::Dynamic item, ::haxe::ds::_List::ListNode next){
            	HX_GC_STACKFRAME(&_hx_pos_d8067612f9234746_266_new)
