...
HX_DEFINE_STACK_FRAME(_hx_pos_e0b7eaab987fd2af_45_new,"haxe.ds.List","new",0x82be24e7,"haxe.ds.List.new","/home/mixer/projects/bonsai/Kha/Tools/haxe/std/haxe/ds/List.hx",45,0x263cbbba)
HX_LOCAL_STACK_FRAME(_hx_pos_e0b7eaab987fd2af_53_add,"haxe.ds.List","add",0x82b446a8,"haxe.ds.List.add","/home/mixer/projects/bonsai/Kha/Tools/haxe/std/haxe/ds/List.hx",53,0x263cbbba)
namespace haxe{
namespace ds{

void List_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_e0b7eaab987fd2af_45_new)
...
void List_obj::add( ::Dynamic item){
            	HX_GC_STACKFRAME(&_hx_pos_e0b7eaab987fd2af_53_add)
