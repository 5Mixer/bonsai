...
HXLINE(  23)					::Main_obj::render(framebuffers->__get(0).StaticCast<  ::kha::Framebuffer >());
            				}
            				HX_END_LOCAL_FUNC1((void))

            				HX_GC_STACKFRAME(&_hx_pos_e47a9afac0942eb9_19_main)
HXLINE(  22)				::kha::Scheduler_obj::addTimeTask( ::Dynamic(new _hx_Closure_0()),( (Float)(0) ),((Float)0.0166666666666666664),null());
HXLINE(  23)				::kha::System_obj::notifyOnFrames( ::Dynamic(new _hx_Closure_1()));
            			}
            			HX_END_LOCAL_FUNC0((void))

            			HX_GC_STACKFRAME(&_hx_pos_e47a9afac0942eb9_19_main)
HXLINE(  19)			::kha::Assets_obj::loadEverything( ::Dynamic(new _hx_Closure_2()),null(),null(),null());
            		}
            		HX_END_LOCAL_FUNC1((void))

            	HX_GC_STACKFRAME(&_hx_pos_e47a9afac0942eb9_18_main)
HXDLIN(  18)		::kha::System_obj::start( ::kha::SystemOptions_obj::__alloc( HX_CTX ,HX_("Bonsai Game",18,95,2b,48),800,600,null(),null()), ::Dynamic(new _hx_Closure_3()));
            	}
