...
HX_LOCAL_STACK_FRAME(_hx_pos_9ef372b503800d85_51_read,"sys.io.File","read",0x203d07e1,"sys.io.File.read","/home/mixer/projects/bonsai/Kha/Tools/haxe/std/cpp/_std/sys/io/File.hx",51,0xbb0e4c4b)
namespace sys{
namespace io{
...
bool File_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::sys::io::FileInput File_obj::read(::String path,hx::Null< bool >  __o_binary){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_9ef372b503800d85_51_read)
