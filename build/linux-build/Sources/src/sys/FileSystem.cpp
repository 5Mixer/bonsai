...
HX_LOCAL_STACK_FRAME(_hx_pos_01451c77b3b28811_38_stat,"sys.FileSystem","stat",0xa630df16,"sys.FileSystem.stat","/home/mixer/projects/bonsai/Kha/Tools/haxe/std/cpp/_std/sys/FileSystem.hx",38,0xc2553f21)
namespace sys{
...
bool FileSystem_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic FileSystem_obj::stat(::String path){
            	HX_STACKFRAME(&_hx_pos_01451c77b3b28811_38_stat)
HXLINE(  39)		::String s;
HXDLIN(  39)		bool s1;
