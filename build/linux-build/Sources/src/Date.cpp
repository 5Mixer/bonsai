...
HX_DEFINE_STACK_FRAME(_hx_pos_9f064efcb7e1e483_26_new,"Date","new",0x9aa26240,"Date.new","/home/mixer/projects/bonsai/Kha/Tools/haxe/std/cpp/_std/Date.hx",26,0x1b532320)
HX_LOCAL_STACK_FRAME(_hx_pos_9f064efcb7e1e483_105_fromTime,"Date","fromTime",0x44fd3cb7,"Date.fromTime","/home/mixer/projects/bonsai/Kha/Tools/haxe/std/cpp/_std/Date.hx",105,0x1b532320)
HX_LOCAL_STACK_FRAME(_hx_pos_9f064efcb7e1e483_112_fromString,"Date","fromString",0x5ead97fb,"Date.fromString","/home/mixer/projects/bonsai/Kha/Tools/haxe/std/cpp/_std/Date.hx",112,0x1b532320)

void Date_obj::__construct(int year,int month,int day,int hour,int min,int sec){
            	HX_STACKFRAME(&_hx_pos_9f064efcb7e1e483_26_new)
...
bool Date_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Date Date_obj::fromTime(Float t){
            	HX_GC_STACKFRAME(&_hx_pos_9f064efcb7e1e483_105_fromTime)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Date_obj,fromTime,return )
 ...
 ::Date Date_obj::fromString(::String s){
            	HX_GC_STACKFRAME(&_hx_pos_9f064efcb7e1e483_112_fromString)
