...
class HXCPP_CLASS_ATTRIBUTES PipelineState_obj : public  ::kha::graphics4::PipelineStateBase_obj
{
	...
	public:
		...
		void setStates(int cullMode,int depthMode,int stencilMode,int stencilBothPass,int stencilDepthFail,int stencilFail,bool depthWrite,int stencilReferenceValue,int blendSource,int blendDestination,int alphaBlendSource,int alphaBlendDestination);
