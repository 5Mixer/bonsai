...
class HXCPP_CLASS_ATTRIBUTES ColoredShaderPainter_obj : public hx::Object
{
	...
	public:
		...
		static void __boot();
		static  ::kha::graphics4::PipelineCache standardColorPipeline;
		...
		inline ::Dynamic _hx_set_g(hx::StackContext *_hx_ctx,::Dynamic _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return g=_hx_v; }
		 ::kha::graphics4::PipelineCache myPipeline;
		inline  ::kha::graphics4::PipelineCache _hx_set_myPipeline(hx::StackContext *_hx_ctx, ::kha::graphics4::PipelineCache _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return myPipeline=_hx_v; }
		 ::kha::graphics4::PipelineCache get_pipeline();
		::Dynamic get_pipeline_dyn();

		 ::kha::graphics4::PipelineCache set_pipeline( ::kha::graphics4::PipelineCache pipe);
